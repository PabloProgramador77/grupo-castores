<x-adminlte-modal id="editarProducto" title="Editar Producto" size="md" theme="primary" icon="fas fa-edit" v-centered static-backdrop scrollable>
    <div class="container-fluid row">
        ...
        <div class="col-lg-12 p-1">
            <form class="form-group">
                <x-adminlte-input type="text" id="nombreEditar" name="nombreEditar" placeholder="*Nombre de producto">
                ...
                <x-adminlte-input type="text" id="precioEditar" name="precioEditar" placeholder="*Precio de producto">
                    <x-slot name="prependSlot">
                        <div class="input-group-text">

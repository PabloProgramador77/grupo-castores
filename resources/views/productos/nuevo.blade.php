<x-adminlte-modal id="nuevoProducto" title="Nuevo Producto" size="md" theme="success" icon="fas fa-plus" v-centered static-backdrop scrollable>
    <div class="container-fluid row">
        ...
        <div class="col-lg-12 p-1">
            <form class="form-group">
                <x-adminlte-input type="text" id="nombre" name="nombre" placeholder="*Nombre de producto">
                ...
                <x-adminlte-input type="text" id="precio" name="precio" placeholder="*Precio de producto">
                    <x-slot name="prependSlot">
                        <div class="input-group-text">
